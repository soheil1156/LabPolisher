...
extern uint32_t PWM_Init( uint32_t channelNum, uint32_t PWMPortNum, uint32_t cycle );
extern void PWM_Set( uint32_t channelNum, uint32_t PWMPortNum, uint32_t offset );
