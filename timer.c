...
void delayMs(uint8_t timer_num, uint32_t delayInMs)
{
  if ( timer_num == 0 )
  {
	...
	LPC_TIM0->MR0 = (SystemCoreClock2 / 4) / (1000/delayInMs);  //enter delay time
...
// #endif
	...
	all the peripherals is 1/4 of the SystemCoreClock2. */
	...
	switch ( pclkdiv )
	{
	  case 0x00:
	  default:
		pclk = SystemCoreClock2/4;
		break;
	  case 0x01:
		pclk = SystemCoreClock2;
		break; 
	  case 0x02:
		pclk = SystemCoreClock2/2;
		break; 
	  case 0x03:
		pclk = SystemCoreClock2/8;
		break;
	}
	LPC_TIM0->PR  = 0;
